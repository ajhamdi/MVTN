...
def color2rgb(color_name):
    """
    converts color name to RGB tuple value of that colr name between 0 and 1 
    """
    if color_name.upper() in COLORS.keys() : 
        return tuple(ti/255.0 for ti in COLORS[color_name.upper()])
    elif color_name.upper()+"1" in COLORS.keys():
        return tuple(ti/255.0 for ti in COLORS[color_name.upper()+"1"])
    else :
        print("No such color as {}".format(color_name))
        return None

def color2rgba(color_name,alpha=1.0):
    """
    converts color name to RGBA tuple value of that colr name between 0 and 1 
    """
    if color_name.upper() in COLORS.keys() : 
        return tuple(list(ti/255.0 for ti in COLORS[color_name.upper()])+[alpha])
    elif color_name.upper()+"1" in COLORS.keys():
        return tuple(list(ti/255.0 for ti in COLORS[color_name.upper()+"1"])+[alpha])
    else :
        print("No such color as {}".format(color_name))
        return None
